        ...
        <>
            <div className='bg-[#1F2937] relative'>
                <div className=' flex justify-end items-start'>
                    <img className='absolute pt-[45px] pr-9' src='./images/footerdesIcon.svg' alt='' />
                </div>

                <div className='mx-auto px-4 container w-full flex flex-col justify-center items-center'>
                    <div>
                        <h1 className='text-[#FFFFFF] text-center text-2xl md:text-4xl leading-10 font-extrabold not-italic inter-bold max-w-[688px] pt-32 pb-14'>Contact Us</h1>
                    </div>
                    <div>
                        <p className='max-w-[347px] md:max-w-[1024px] text-[#FFFFFF] text-center text-base  md:text-lg  leading-7 font-normal not-italic inter-medium pb-14'>Finding a job that matches your skills & interest is a lot easier now, You can browse the jobs & apply whenever & wherever you want. Finding a Job that matches your skills & interest is a lot easier now, You can browse the jobs & apply whenever & wherever you want.</p>
                    </div>
                </div>
                ...
                <div className='mx-auto container w-full flex justify-center items-center '>
                    <div className='flex  flex-col lg:flex-row justify-between items-center lg:space-x-[158.67px] mt-14 mb-20'>

                        <div className='flex  justify-start lg:justify-center items-center'>
                            <div>
                                <img className='' src='./images/mobile.svg' alt='' />
                            </div>
                            <div>
                        ...
                        <div className='flex justify-center items-center'>
                            <div>
                                <img className='' src='./images/location.svg' alt='' />
                            </div>
                            <div>
                        ...
                        <div className='flex justify-center items-center'>
                            <div>
                                <img className='' src='./images/message.svg' alt='' />
                            </div>
                            <div>
